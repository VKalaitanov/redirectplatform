...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _components_chart_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./components/chart.js */ "./src/js/components/chart.js");
/* harmony import */ var _components_treeselect_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/treeselect.js */ "./src/js/components/treeselect.js");
/* harmony import */ var _functions_modal_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./functions/modal.js */ "./src/js/functions/modal.js");
/* harmony import */ var _functions_header_active_link_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./functions/header-active-link.js */ "./src/js/functions/header-active-link.js");
/* harmony import */ var _functions_tabs_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions/tabs.js */ "./src/js/functions/tabs.js");
/* harmony import */ var _functions_switch_platform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./functions/switch-platform.js */ "./src/js/functions/switch-platform.js");
/* harmony import */ var _functions_click_price_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./functions/click-price.js */ "./src/js/functions/click-price.js");
...
let userChartGlobal;
let adminChartGlobal;
const userChart = document.getElementById('statistics-chart');
const adminChart = document.getElementById('admin-statistics-chart');
if (userChart) {
  userChartGlobal = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](userChart, {
    type: 'bar',
    data: {
...
if (adminChart) {
  adminChartGlobal = new chart_js_auto__WEBPACK_IMPORTED_MODULE_0__["default"](adminChart, {
    type: 'bar',
    data: {
      labels: ["25 March Mon", "26 March Tue", "27 March Wed", "28 March Thu ", "29 March Fri ", "30 March Sat", "31 March Sun"],
      datasets: [{
...
/***/ "./src/js/components/treeselect.js":
/*!*****************************************!*\
  !*** ./src/js/components/treeselect.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var treeselectjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! treeselectjs */ "./node_modules/treeselectjs/dist/treeselectjs.mjs");
...
const geoSelect = document?.querySelector('#geo');
const modalGeoSelect = document?.querySelector('#modal-geo');
const typeSelect = document?.querySelector('#type');
const typeInvoceSelect = document?.querySelector('#type-invoce');
const userTypeInvoceSelect = document?.querySelector('#user-payments-type');
const formatSelect = document?.querySelector('#format');
const formatUserModalSelect = document?.querySelector('#format-user-modal');
const succesfulSelect = document?.querySelector('#succesful');
const managerfulSelect = document?.querySelector('#manager');
const managerModalfulSelect = document?.querySelector('#manager-modal');
const modalTypeSelect = document?.querySelector('#modal-type');
const osSelect = document?.querySelector('#os');
const modalUserSourceSelect = document?.querySelector('#modal-user-source');
const modalSourceSelect = document?.querySelector('#modal-source');
const modalFormatSelect = document?.querySelector('#modal-format');
const adminModalCampaignSelect = document?.querySelector('#modal-user');
if (statusSelect) {
  new treeselectjs__WEBPACK_IMPORTED_MODULE_0__["default"]({
...
/***/ "./src/js/functions/click-price.js":
/*!*****************************************!*\
  !*** ./src/js/functions/click-price.js ***!
  \*****************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
document?.addEventListener('click', e => {
  if (e.target.closest('.button-edit')) {
    const parent = e.target.closest('.admin-click-prices__price');
    const value = parent?.querySelector('.admin-click-prices__value');
...
/***/ "./src/js/functions/header-active-link.js":
/*!************************************************!*\
  !*** ./src/js/functions/header-active-link.js ***!
  \************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
headerLinks?.forEach(element => {
  if (element?.href.includes(window.location.pathname)) element?.classList.add('header__link_active');
});
...
document?.addEventListener('click', e => {
  if (e.target.hasAttribute('data-modal-id') && e.target.closest('button')) {
    _vars_js__WEBPACK_IMPORTED_MODULE_0__["default"].isOpenModal = true;
    const modalId = e.target.getAttribute('data-modal-id');
    const modalName = document.querySelector(`[data-modal-name=${modalId}]`);
    const modalHolder = modalName?.querySelector('.modal__holder');
    const modalClose = modalName?.querySelector('.modal__close');
    modalName.classList.add('is-open');
    document.body.classList.add('scroll-hidden');
    modalHolder.addEventListener('click', () => {
      modalName.classList.remove('is-open');
      setTimeout(() => {
    ...
    addEventListener("keydown", event => {
      if (event.code === 'Escape') {
        ...
        _vars_js__WEBPACK_IMPORTED_MODULE_0__["default"].isOpenModal = false;
      }
    });
  }
});
...
/***/ "./src/js/functions/switch-platform.js":
/*!*********************************************!*\
  !*** ./src/js/functions/switch-platform.js ***!
  \*********************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
const modalPlatform = document.getElementById('platform-radios');
const modalPlatformRadios = modalPlatform?.querySelectorAll('[type=radio]');
const modalOs = document.getElementById('platform-os');
const modalDesktop = document.getElementById('platform-desktop');
modalPlatformRadios?.forEach(element => {
  element?.addEventListener('input', function () {
    if (this.value) {
      if (this.value.toLowerCase() === 'mobile') {
        modalOs.classList.remove('hide');
      } else {
        modalOs.classList.add('hide');
      }
      if (this.value.toLowerCase() === 'desktop') {
...
tabs?.forEach(tab => {
  tab.addEventListener('click', function () {
    tabs.forEach(el => {
      el.classList.remove('tab__button_active');
    });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Gi)
/* harmony export */ });
